...
// 2. Status check for button disabling
...
// 3. Fetch LATEST records for display (Fixed "stuck" issue)
...
<body>
    ...
    <div class="left-nav" style="display: flex; align-items: center; gap: 24px; flex-grow: 1; height">
            ...
            <div class="makerow-container">
                <div class="inout-container">
                    ...
                    <div class="time-out-container">
                        ...
                        <div class="time-column">
                            <form id="timeoutForm" method="POST" action="time_out.php">
